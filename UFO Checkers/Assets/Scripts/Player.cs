...
{
    public enum SelectionState { NO_SELECTION, UFO_SELECTION, MOVE_SELECTION }
    public enum MoveDirection { POS_X, POS_Y, NEG_X, NEG_Y }
    ...
    public class Player : MonoBehaviour
    {
        ...
        [field: SerializeField] private Player_Selection player_selection;
